...
public class HighScores : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        //will set the directory to the txt file, will run a message to the console to assure this line of code runs
    ...
    //Function will load the values from the txt file
    public void LoadScoresFromFile()
    {
        ...
        if (fileExists == true)
        {
            ...
            //Sends a message to the console to show the program was successful in finding and reading the txt file
        ...
        else
        {
            ...
            //If unsuccessful it will display tis message in the console instead
    ...
    //This function will save the time the game was completed in to the txt file
    public void SaveScoresToFile()
    {
        ...
        for (int i = 0; i< scores.Length; i++)
        {
            ...
            //Inputs scores into the text files
    ...
    //Function will check the score given from the game, if the score is lower than the highest current value in the txt file, it will add it to the txt file
    public void AddScore(int newScore)
    {
        ...
        if (desiredIndex < 0)
        {
            ...
            Debug.Log("Score of " + newScore + " not enough for high scores list.", this);
            return;
